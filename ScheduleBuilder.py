...
class ScheduleBuilder:
    ...
    @staticmethod
    def solve_json(student_json: str, course_json: str) -> tuple[dict[int, list[tuple[str, str, str]]], int, tuple[float, str], list[tuple[str, float, float]]]:
        ...
        ScheduleBuilder.check_data_validity(student_json, course_json)
